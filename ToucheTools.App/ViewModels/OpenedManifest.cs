...
public class OpenedManifest : Observable<OpenedManifest.Manifest>
{
    ...
    public OpenedManifest(OpenedPackage package, OpenedPath path)
    {
        _package = package;
        _path = path;
