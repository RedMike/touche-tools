...
{
    private readonly ILogger _logger = LoggerFactory.Create((builder) => builder.AddSimpleConsole()).CreateLogger(typeof(IconImageDataLoader));
    ...
    public void Read(int number, out IconImageDataModel sprite)
    {
        ...
        _logger.Log(LogLevel.Information, "Icon image {}: initially {}x{}", number, initialWidth, initialHeight);
